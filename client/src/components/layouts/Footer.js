...
const Footer = () => {
    return <>
        ...
        <div>
            <div className="bg-gray-50 py-4 text-slate-950">
                <div className="container px-4 mx-auto">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-1/5">
                            <Link to={"/"} className='flex  items-center gap-5 py-2' >
                                <img src={Footerlogo} alt="" width={100} className='rounded-full ' />
                                <h1 className="width-full text-4xl font-bold text-indigo-700">
                                    TechMart
                                </h1>
                            </Link>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Others</h2>
                            </div>
                            <ul className="leading-8">
                                <li><a href="#" className="hover:text-blue-400">Cart</a></li>
                                <li><a href="#" className="hover:text-blue-400">Checkout
                                </a></li>
                                <li><a href="#" className="hover:text-blue-400">Shop</a></li>
                                <li><a href="#" className="hover:text-blue-400">FAQ
                                </a></li>
            ...
            <div className="bg-slate-900 py-4 text-gray-100">
                <div className="container mx-auto px-4">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 w-full text-center sm:w-auto sm:text-left">All Rights Reserved 2023
                        </div>
